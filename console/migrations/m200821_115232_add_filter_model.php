...
class m200821_115232_add_filter_model extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex('filter_attribute_strategy_uindex', 'filter', ['attribute_uuid', 'strategy'], true);
        $this->createIndex('filter_option_strategy_uindex', 'filter', ['option_uuid', 'strategy'], true);
